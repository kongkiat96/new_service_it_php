...
$reqService = '<script type="text/javascript">
    Swal.fire({
        ...
        html:
          "เรียบร้อยแล้วขั้นตอนถัดไป ระบบจะส่งข้อความแจ้งเตือน ไปถึง เจ้าหน้าที่ที่เกี่ยวข้อง เพื่อตรวจสอบและประเมินการซ่อม. <br><br>แจ้งเตือนจะปิดลงและจะนำไปยังหน้ารายการในอีก <strong></strong> วินาที.<br/>",
        timer: 10000,  
        showConfirmButton: false,
        didOpen: () => {
