...
<div class="modal-header">
    <h5 class="modal-title"><strong>ดำเนินงาน</strong></h5>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <label class="form-label-md fw-semibold mb-2">แจ้งซ่อมวัสดุ </label>
                ...
                <div class="row mt-3">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <select id="select2" name="status" class="form-control" required autofocus>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 mt-3">
                        <label for="pic" class="form-label-md fw-semibold mb-2">รูปภาพแนบ
                            เมื่อดำเนินงานเสร็จสิ้น</label>
...
<div class="modal-footer">
    ...
    <?php if($chk_case->se_assign == null || $chk_case->se_assign == $_SESSION['ukey']){?>
