            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <?php include 'layout/user/service_form.php';?>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <?php echo @$system_info->site_name; ?>  <script>document.write(new Date().getFullYear());</script> Information System Design & Develop By SSIT
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
