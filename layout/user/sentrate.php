                ...
                <div class="timeline-event">
                    ...
                    <div class="d-flex flex-wrap justify-content-between mb-2">
                        <div>
                            ...
                            <span><?php echo $chk_case->se_other; ?>, ชื่อวัสดุ :
            ...
            <li class="timeline-item timeline-item-info mb-4">
                ...
                <div class="timeline-event">
                    <div class="timeline-header border-bottom mb-3">
                        ...
                        <?php if($chk_case->status != null){?>
                            <small class="text-muted"><?php echo @dateConvertor($chk_case->date_update);?> , เวลา :<?php echo $chk_case->time_update; ?></small>
                        <?php } ?>
                    </div>
                    <div class="d-flex flex-wrap justify-content-between mb-2">
                        <div>
                        ...
                        <div>
                            <div class="rate">
                                <input type="radio" id="star5" name="rate" value="5"
                                    <?php echo $chk_case->rate == '5' ? 'checked' : ''; ?> />
                                <label for="star5" title="text">5 stars</label>
                                <input type="radio" id="star4" name="rate" value="4"
                                    <?php echo $chk_case->rate == '4' ? 'checked' : ''; ?> />
                                <label for="star4" title="text">4 stars</label>
                                <input type="radio" id="star3" name="rate" value="3"
                                    <?php echo $chk_case->rate == '3' ? 'checked' : ''; ?> />
                                <label for="star3" title="text">3 stars</label>
                                <input type="radio" id="star2" name="rate" value="2"
                                    <?php echo $chk_case->rate == '2' ? 'checked' : ''; ?> />
                                <label for="star2" title="text">2 stars</label>
                                <input type="radio" id="star1" name="rate" value="1"
                                    <?php echo $chk_case->rate == '1' ? 'checked' : ''; ?> />
...
<div class="modal-footer">
    ...
    <?php if($chk_case->status == '2e34609794290a770cb0349119d78d21' && $chk_case->rate == null){?>
    <button type="submit" name="saverate" class="btn btn-primary"><i class="bx bx-save"></i>
        บันทึกข้อมูล</button>
    <input type="hidden" name="ticket" value="<?php echo $chk_case->ticket; ?>">
    <?php }?>
